...
Based on study and paper "Effects of Exenatide Plus Rosiglitazone on B-Cell Function and Insulin Sensitivity in
...
Data based on GWAY study, recreated through rnorm(nrow(),mean=1,sd=0.2) results include:
